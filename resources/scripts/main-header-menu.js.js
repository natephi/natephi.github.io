...
const toggleMainHeader=window.onscroll=()=>{let currentScrollPosition=window.pageYOffset
...
const closeDropdownMenu=()=>{dropdownMenuState=0
dropdownMenu.style.height="0"}
const toggleDropdownMenu=n=>{dropdownMenuState+=n
switch(dropdownMenuState){case 1:openDropdownMenu()
break
case 2:closeDropdownMenu()
break
default:closeDropdownMenu()}}
